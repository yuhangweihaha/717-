            ...
            <div class="main-wrap">
                <div class="swiper-container">
                    <ul class="swiper-wrapper">
                        <li class="swiper-slide"><img src="../../assets/pic_4.png"></li>
                        <li class="swiper-slide"><img src="../../assets/pic_3.png"></li>
                        <li class="swiper-slide"><img src="../../assets/pic_2.png"></li>
                        <li class="swiper-slide"><img src="../../assets/pic_1.png"></li>
                    </ul>
                ...
                <div class="icon-lists">
                    <div class="icon-lists-top">
                        <dl>
                            <dt style="background: #47D265"><img src="../../assets/swiper2.png"></dt>
                            <dd> 家乡味道</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FF7902"><img src="../../assets/swiper8.png"></dt>
                            <dd>进口食品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BAAFF"><img src="../../assets/swiper1.png"></dt>
                            <dd>牛奶乳品</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFB447"><img src="../../assets/swiper7.png"></dt>
                            <dd>茶果冲引</dd>
                        </dl>
                    </div>
                    <div class="icon-lists-bot">
                        <dl>
                            <dt style="background: #FF655B"><img src="../../assets/swiper3.png"></dt>
                            <dd>休闲零食</dd>
                        </dl>
                        <dl>
                            <dt style="background: #67CCFF"><img src="../../assets/swiper5.png"></dt>
                            <dd>米面粮油</dd>
                        </dl>
                        <dl>
                            <dt style="background: #FFD33C"><img src="../../assets/swiper4.png"></dt>
                            <dd>调味调料</dd>
                        </dl>
                        <dl>
                            <dt style="background: #5BDCC8"><img src="../../assets/seiper6.png"></dt>
                            <dd>酒水新料</dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="foodie">
                    <div class="foodie-left"><img src="../../assets/1486717244775.jpg"></div>
                    <div class="foodie-right">
                        <div class="foodie-right-top">

                            <img src="../../assets/dayday1_03.png">
                        </div>
                        <div class="foodie-right-bottom">

                            <img src="../../assets/dayday2_03.png">
                        </div>
                    </div>
                </div>
